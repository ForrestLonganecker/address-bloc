...
describe("ContactController", () => {
    ...
    describe("search methods", () => {
        ...
        const snake = ["Solid Snake", "101-100-1000", "snake@konami.com"];
        const magus = ["Magus Johnson", "002-200-2001", "magus@squaresoft.com"];
        const alloy = ["Alloy Rodriguez", "324-162-2756", "allow@guerrilla-games.com"];
                ...
                .then(() => {
                    ...
                    .then(() => {
                        ...
                        .then((contacts) => {
                            ...
                            expect(contact.phone).toBe("002-200-2001");
        ...
        describe("#binarySearch()", () => {
            ...
            it("should return null when contact is not found", (done) => {
                ...
                .then(() => {
                    this.book.getContacts()
                    .then((contacts) => {
                        expect(this.book.binarySearch(sort(contacts), "Alloy Rodriquez")).toBeNull();
                        done();
                    })
                    .catch((err) => {
                        console.log(err);
            ...
            it("should return the contact when found", (done) => {
                ...
                .then(() => {
                    ...
                    .then((contact) => {
                        ...
                        expect(contact.phone).toBe("101-100-1000");
